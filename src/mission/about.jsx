            ...
            <div className='text-white mx-auto justify-center items-center md:px-10 px-2 max-w-screen-2xl'>
                <div className='md:pt-72 pt-10 max-w-screen-xl mx-auto lg:px-10 px-5'>
                    <div className='max-w-screen-lg'>
                        <h1 data-aos="fade-left" data-aos-delay="100" className='lg:text-5xl md:text-4xl sm:text-4xl text-2xl mx-auto text-[#fff] lg:py-5 py-2'>
                            Our Commitment to Excellence
                        </h1>
                        <p data-aos="fade-right" data-aos-delay="200" className='text-[#747474] lg:pt-3 pt-5'>
