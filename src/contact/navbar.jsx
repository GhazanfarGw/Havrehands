...
function Navbar () {
  ...
  return (
    <>
      <header className="top-0 sticky z-20 md:px-10 px-3 w-full duration-300 mx-auto items-center bg-[#01375D] text-white overflow-x-hidden shadow-md md:py-2 scroll-smooth">
