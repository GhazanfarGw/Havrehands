        ...
        <div className='justify-center mx-auto items-center pb-20 bg-[#0D0D0D]'>
            <div className='text-white mx-auto justify-center items-center md:px-10 px-2 max-w-screen-2xl'>
                <div className='md:flex md:grid-cols-2 gap-x-20 md:pt-72 pt-10 max-w-screen-xl mx-auto lg:px-10 px-5'>
                    ...
                    <div data-aos="fade-left" data-aos-delay="300" className='hidden md:block lg:block xl:block'>
                ...
                <div className='justify-center py-5 items-center lg:pt-32 pt-10'>
                    <div className='px-4'>
                        <div className='md:flex md:flex-row gap-3'>
                            ...
                            <div data-aos="fade-left" data-aos-delay="400" className='bg-[#1a1e24] hover:bg-[#18C4FF] text-white hover:text-black py-5 px-5 md:w-80 md:mt-0 mt-5 hover:scale-105 duration-300 transform:translate3d(0%, 0%, 0px);'>
                            ...
                            <div data-aos="fade-right" data-aos-delay="500" className='bg-[#1a1e24] hover:bg-[#18C4FF] text-white hover:text-black py-5 px-5 md:w-80 md:mt-0 mt-5 hover:scale-105 duration-300 transform:translate3d(0%, 0%, 0px);'>
                                <img className='' src='./Digital-Marketing.png' alt='logo'/>
                                <h1 className='text-lg lg:text-xl font-semibold justify-center lg:pt-5 pt-3'>
                                    Optimizing
                                </h1>
