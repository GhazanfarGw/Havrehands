...
const Dashboard = () => {
    return (
        <>
            <div data-aos="fade-up" data-aos-delay="300" className='duration-500 justify-center'>
                <div className='md:h-80 shadow-2xl'>
                    <img className='duration-500 w-full object-cover md:h-[32rem] rounded-xl' src='./Approach.jpg' alt='image'/>
                </div>
