...
function Dashboard() {
  ...
  const slides = [
    { images: '/Name.png' },
    { heading: 'Vision', text: 'Our Vision For The Future' },
    { heading: 'Mission', text: 'Our Commitment to Excellence' },
    { heading: 'Approach', text: 'Our Collaborative Approach to Success' },
  ];
  ...
  return (
    <div className='duration-500 Main-home-page-banner relative overflow-hidden z-0'>
      {slides.map((slide, index) => (
        ...
        >
          <div className='max-w-screen-xl mx-auto justify-center text-center md:min-h-screen md:py-10 lg:px-10 px-5 overflow-hidden'>
            <div className='items-start absolute top-1/2 right-0 left-0 duration-500'>
              <div className="justify-center">
                <div className="justify-center">
                  <img
                    data-aos="fade-in"
                    data-aos-delay="300"
                    className='absolute top-1/2 right-0 left-0 xl:max-w-2xl lg:max-w-xl md:max-w-xl max-w-64 mx-auto text-center'
                    src={slide.images} />
                </div>
              </div>
              <div className='absolute top-1/2 right-0 left-0 justify-center mx-auto'>
                <div
                  className='max-w-2xl mx-auto text-center'
                  data-aos="fade-in"
                  data-aos-delay="400"
                >
                  <h1 style={{ fontFamily: 'CustomFont' }} className='text-[#60A7BA] uppercase xl:text-7xl lg:text-7xl md:text-6xl text-4xl tracking-widest'>{slide.heading}</h1>
                </div>
                <div
                  className='max-w-2xl mx-auto text-center'
                  data-aos="fade-in"
