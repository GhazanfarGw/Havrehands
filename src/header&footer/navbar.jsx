...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      ...
      {isScrolled ? (
        <header className="fixed z-10 md:px-10 px-3 w-full duration-300 mx-auto items-center bg-[#353535] text-white overflow-x-hidden shadow-md md:py-2 scroll-smooth">
        ...
        >
          {(ref) => (
            <div className="lg:hidden w-full pb-10 mt-3 bg-[#353535] text-white" id="mobile-menu">
          ...
          <div className="flex items-center">
            <div className="flex items-center w-full">
              <div className="flex-shrink-0 md:py-2 items-center duration-200">
                <a href="/">
                  <img width={220} className='items-center hidden md:block lg:block duration-200' src='./Landscape-logo.png' alt='favicon.png'/>
                  <img width={185} className='items-center md:hidden block lg:hidden duration-200' src='./Landscape-logo.png' alt='favicon.png'/>
                </a>
              </div>
              <div className="hidden lg:block w-full duration-200 scroll-smooth">
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
