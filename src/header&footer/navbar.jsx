...
function Navbar () {
  ...
  return (
    <>
      <header className={`header bottom-0 ${isSticky ? 'top-0 sticky z-20 md:px-10 px-3 w-full duration-300 mx-auto items-center bg-[#01375D] text-white overflow-x-hidden shadow-md py-2 scroll-smooth' : ''}`}>
            ...
            <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
              ...
              <div className="hidden lg:block w-full duration-200 scroll-smooth">
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
                  ...
                  <div>
                    <a href="./contact-us" class="items-center text-base border  relative h-8 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row tracking-wide">
                      Contact Us
                    </a>
                  </div>
        ...
        >
          {(ref) => (
            <div className="lg:hidden w-full pb-10 mt-3 bg-[#01375D] text-white relative" id="mobile-menu">
              <div ref={ref} className="mx-auto z-50 px-5 flex flex-col">
                ...
                <div>
                  <a href="./contact-us" class="items-center text-base mt-5 text-white bg-[#18C4FF] border relative h-8 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row tracking-wide">
                    Contact Us
                  </a>
                </div>
              </div>
