                ...
                <div className='justify-center py-5 items-center lg:pt-32 pt-10'>
                    <div className='px-4'>
                        ...
                        <div className='md:flex md:flex-row gap-3'>
                            ...
                            <div data-aos="fade-left" data-aos-delay="400" className='bg-[#1a1e24] hover:bg-[#09121C] text-white py-5 px-5 cursor-wait md:w-80 md:mt-0 mt-5 hover:scale-105 duration-300 transform:translate3d(0%, 0%, 0px);'>
                            ...
                            <div data-aos="fade-right" data-aos-delay="500" className='bg-[#1a1e24] hover:bg-[#09121C] text-white py-5 px-5 cursor-wait md:w-80 md:mt-0 mt-5 hover:scale-105 duration-300 transform:translate3d(0%, 0%, 0px);'>
                                <img className='' src='./Digital-Marketing.png' alt='logo'/>
                                <h1 className='text-lg lg:text-xl font-semibold justify-center lg:pt-5 pt-3'>
                            ...
                            <div data-aos="fade-left" data-aos-delay="600" className='bg-[#1a1e24] hover:bg-[#09121C] text-white py-5 px-5 cursor-wait md:w-80 md:mt-0 mt-5 hover:scale-105 duration-300 transform:translate3d(0%, 0%, 0px);'>
                                <img className='' src='./Digital-Marketing.png' alt='logo'/>
                                <h1 className='text-lg lg:text-xl font-semibold justify-center lg:pt-5 pt-3'>
